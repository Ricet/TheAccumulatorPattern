...
def run_test_sum_more_cosines():
    ...
    # Test 2:
    expected = -0.3998036453  # This is APPROXIMATELY the correct answer.
    answer = sum_more_cosines(3, 6)
    print('Test 2 expected:', expected, '(approximately)')
    print('       actual:  ', answer)

    # Test 3:
    expected = 1.478254079  # This is APPROXIMATELY the correct answer.
...
def run_test_count_sines_vs_cosines():
    ...
    # Test 5:
    expected = 401
    answer = count_sines_vs_cosines(400)
    print('Test 5 expected:', expected)
    print('       actual:  ', answer)
